...
public enum CountryCode {
    ...
    RUSSIA("+7", "RU"),
    RWANDA("+250", "RW"),
    SAINT_KITTS_AND_NEVIS("+1", "KN"),
    SAINT_LUCIA("+1", "LC"),
    SAINT_VINCENT_AND_THE_GRENADINES("+1", "VC"),
    SAMOA("+685", "WS"),
    SAN_MARINO("+378", "SM"),
    ...
    CountryCode(String phoneCode, String isoCode) {
